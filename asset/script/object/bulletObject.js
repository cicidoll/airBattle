class Bullet {
  ...
  creatDom(label){
    ...
    this.bullet.style.cssText += `height:${this.size.height}px;width:${this.size.width}px;`
  }
  ...
  addPosition(){
    this.bullet.style.cssText += `top:${this.position.top}px;left:${this.position.left}px;`
  }
}